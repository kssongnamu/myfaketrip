<template>
    <div>
        <headerCp></headerCp>
        <main>
            <section class="mx-auto mb-5" style="max-width: 1060px;" v-for="SwiperData in [dummy.CityCard, dummy.Banner, dummy.RecentItem, dummy.MAIN_TOPN, dummy.MAIN_TOPN, dummy.MAIN_TOPN]">
